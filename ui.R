...
##############################################################################################################################
	dashboardBody(
	    ...
	    tags$head(
	        includeCSS("www/styles.css") # Correction for greyed out ggvis plots
	    ),
		...
		tabItems(
    		...
    		tabItem(tabName = "About",
    				...
    				fluidRow(
    				    column(width = 4, valueBox(70, HTML("UK Biobank traits"), icon = icon("medkit"), width = 12, color = "blue")),
    				    ...
    				    column(width = 4, valueBox(format("418,898", big.mark = ","), HTML("Variants identified by PRISM"), color = "blue", icon = icon("check"), width = 12))
    				),
    				fluidRow(
    			...
    			tabItem(tabName = "VariantNet",
    				...
    				fluidRow(
    				    box(
    				        ...
    				        selectInput("PleioType", label = "", choices = c(`Horizontal pleiotropy` = "Direct Effect", `Vertical pleiotropy` = "Vertical Pleiotropy", `Confounder pleiotropy` = "Confounder Pleiotropy")),
